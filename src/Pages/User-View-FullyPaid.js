...
const  UserFullyPaidLoansPage= () => {
  const [fullPaidLoans, setFullyPaidLoans] = useState([]);
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        if (Array.isArray(data)) {
            setFullyPaidLoans(data.filter((loan) => loan.status === 'fully paid'));
  ...
  if (loading) {
    return (
      <LoadingContainer>
        ...
        <LoadingText>Loading Fully Paid Loan Info...</LoadingText>
      </LoadingContainer>
    );
  }
